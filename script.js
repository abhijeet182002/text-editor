...
function applyFormat(tag) {
  ...
  // Fix: If selection is a text node, use its parent to check containment
...
async function saveAsTextFile() {
  const editor = document.getElementById("textArea");
  const content = editor.innerText; // .innerText for plain text (no HTML tags)

  // Check if the browser supports file saving
